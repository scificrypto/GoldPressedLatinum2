...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("goldpressedlatinum-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("goldpressedlatinum-net");
...
static const char *strDNSSeed[][2] = {
    {"goldpressedlatinum.com", "dnsseed.goldpressedlatinum.com"},
    {"goldpressedlatinumpool", "pool.goldpressedlatinum.com"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("goldpressedlatinum-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("goldpressedlatinum-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("goldpressedlatinum-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("goldpressedlatinum-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GoldPressedLatinum is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("goldpressedlatinum-start");
