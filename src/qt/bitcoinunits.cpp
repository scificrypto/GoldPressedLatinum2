...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("GPL");
    case mBTC: return QString("mGPL");
    case uBTC: return QString::fromUtf8("μGPL");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("GoldPressedLatinums"));
    case mBTC: return QString(QObject::tr("Milli-GoldPressedLatinums (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-GoldPressedLatinums (1 / 1,000,000)"));
    default: return QString("???");
    }
}
